...
# Requirements
- Show the available modules for each course, for each module:
	- Show the Module Name and Code
	- Give a short description
	- Show Assesment Structure
	- Show Terms and Lecturers
	- Show how it fits into the programme (core, compulsory, optional)
- Split Modules by Semester
- Show the possible degree titles/specialisations based on the chosen modules
- Indicate whether a particular selection of modules is valid